...
import { IUser } from 'src/app/core/config/auth/model/user';

@Injectable()
export class AlunoService implements Resolve<any> {
    routeParams: any;
    nota: any;
